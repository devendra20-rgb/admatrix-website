...
const Hero = () => {
  ...
  const logoMap = {
    mcd: "/logos/mcd.png",
    jawwy: "/logos/jawwy.png",
    noon: "/logos/noon.png",
    stc: "/logos/stc.png",
    keeta: "/logos/keeta.png",
    kfc: "/logos/kfc.png",
    mashreq: "/logos/mashreq.png",
    careem: "/logos/careem.png",
    ifood: "/logos/ifood.png",
    pizzahut: "/logos/Pizza_Hut.png",
  };

  return (
    <section className="relative w-full bg-[#0a061f] overflow-hidden flex flex-col justify-between ">
      {/* Background Layers */}
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-violet-400 via-purple-400 to-orange-400 bg-clip-text text-transparent block text-[18px] md:text-[28px] lg:text-[32px] font-bold leading-[1.2] mb-12 max-w-4xl tracking-tight">
                Admatrix is where strategy meets execution - a full-funnel
                digital media agency that connects the right message, to the
                right audience, on the right platform, at the right moment.
              </span>
